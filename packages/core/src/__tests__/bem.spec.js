...
describe('bem', () => {
	...
	describe('element', () => {
		...
		it('should output correct classnames for value element modifiers', () => {
			...
			).toEqual(['fake-element', 'fake-element--value-modifier_fake-value']);
		});
	});
	...
	describe('syntax', () => {
		it('should output correct classnames for classic bem syntax', () => {
			expect(
				bem({
					block: 'fakeBlock',
					element: 'fakeElement',
				...
				'fakeBlock__fakeElement',
				'fakeBlock_valueBlockModifier_fakeBlockValue',
				'fakeBlock_valueBlockBooleanModifier',
				'fakeElement',
				'fakeElement_valueElementModifier_fakeElementValue',
				'fakeElement_valueElementBooleanModifier',
			]);
		});

		it('should output correct verbose classnames for classic bem syntax', () => {
			expect(
				bem({
					block: 'fakeBlock',
					element: 'fakeElement',
				...
				'fakeBlock__fakeElement',
				'fakeBlock_valueBlockModifier_fakeBlockValue',
				'fakeBlock_valueBlockModifier_fakeBlockValue__fakeElement',
				'fakeBlock_valueBlockBooleanModifier',
				'fakeBlock_valueBlockBooleanModifier__fakeElement',
				'fakeElement',
				'fakeElement_valueElementModifier_fakeElementValue',
				'fakeBlock__fakeElement_valueElementModifier_fakeElementValue',
				'fakeElement_valueElementBooleanModifier',
				'fakeBlock__fakeElement_valueElementBooleanModifier',
			]);
		});
	});
});
