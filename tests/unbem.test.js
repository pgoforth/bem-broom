...
import unbem from '../src/unbem'
import standard from '../src/syntax/standard'
...
describe('unbem', () => {
    describe('block', () => {
        ...
        it('should output correct bem objects for prefixed block', () => {
            expect(unbem('fake-prefix-fake-block', {
                prefix: 'fake-prefix-',
            })).toEqual([{
                block: 'fake-block',
            }])
        ...
        it('should output correct bem objects for when no block provided with prefix', () => {
            expect(unbem('fake-prefix-__fake-element', {
                prefix: 'fake-prefix-',
            })).toEqual([])
        })
    ...
    describe('element', () => {
        ...
        it('should output correct bem objects for prefixed element', () => {
            expect(unbem('fake-prefix-fake-block__fake-element', {
                prefix: 'fake-prefix-',
            })).toEqual([{
                block: 'fake-block',
                element: 'fake-element',
        ...
        it('should output correct bem objects for value element modifiers', () => {
            expect(unbem('fake-block__fake-element--value-modifier_fake-value')).toEqual([{
                block: 'fake-block',
                element: 'fake-element',
                modifiers: {
                    element: {
    ...
    describe('syntax', () => {
        it('should output correct bem objects for standard bem syntax', () => {
            expect(unbem('fakeBlock--fakeElement-valueElementModifier-fakeElementValue', {
                syntax: standard,
            })).toEqual([{
                block: 'fakeBlock',
                element: 'fakeElement',
